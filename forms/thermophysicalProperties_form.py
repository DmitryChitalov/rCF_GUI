...
# ------------------------Функции связанные с формой-----------------------------
        ...
        def on_btnSave_clicked():
            ...
            parent.item = QtGui.QListWidgetItem("Сохранен файл: thermophysicalProperties", parent.listWidget)
