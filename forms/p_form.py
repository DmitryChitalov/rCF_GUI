...
#--------------------------------Третий блок.Разметка и вывод данных----------------------------------
        ...
        for j in range(len(mas)):
            ...
            type_frame.setFixedSize(280, 40)
...
#------------------------------------------------------------------------
        ...
        def on_btnSave_clicked():
            ...
            parent.item = QtGui.QListWidgetItem("Сохранен файл: p", parent.listWidget)
